...
const EditDepartment = () => {
    ...
    useEffect(() => {
        const fetchDepartments = async () => {
            ...
            try {
                ...
                const response = await axios.get(`https://ems-system-backend.vercel.app/api/department/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
          try{
            const response = await axios.put(`https://ems-system-backend.vercel.app/api/department/${id}`, department, {
                headers: {
                    "Authorization" : `Bearer ${localStorage.getItem('token')}`
                }
            })
